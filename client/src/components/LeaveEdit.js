          ...
          <a href="/adminlogin"><i className="fa fa-fw fa-user"></i>Log Out</a>
            ...
            <div className="col-md-8 mt-4 mx-auto">
              ...
              <div className="form-group" style={{ marginBottom: '15px' }}>
                ...
                <div className="form-group" style={{ marginBottom: '15px' }}>
                <label style={{ marginBottom: '5px' }}>Stasus</label>
                <select value={this.state.pending} onChange={this.onchangestatus}
                  className="form-control"
                  name="pending">

                 <option>Pending</option>
                  <option value="Approved"  onChange={this.onchangestatus}>Approve</option>
                  <option value="Declined" onChange={this.onchangestatus}>Decline</option>
